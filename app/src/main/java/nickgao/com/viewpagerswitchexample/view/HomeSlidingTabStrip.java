...
public class HomeSlidingTabStrip extends LinearLayout {
    ...
    private HomeSlidingTabLayout.TabColorizer mCustomTabColorizer;
    ...
    public void setCustomTabColorizer(HomeSlidingTabLayout.TabColorizer customTabColorizer) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        final HomeSlidingTabLayout.TabColorizer tabColorizer = mCustomTabColorizer != null
                ? mCustomTabColorizer
                : (HomeSlidingTabLayout.TabColorizer) mDefaultTabColorizer;
